...
plt.figure(figsize=(12, 6))
sns.scatterplot(x='Credit_Limit', y='Avg_Utilization_Ratio', data=df, marker='x')
...
sns.scatterplot(x='Customer_Age', y='Credit_Limit', hue='Income_Category', data=df, palette='viridis', marker='x')
